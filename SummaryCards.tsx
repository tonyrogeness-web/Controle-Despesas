      ...
      {cards.map((card, idx) => (
        ...
        >
          ...
          <div className="flex items-center justify-between relative z-10">
            <div className="p-2 md:p-3 bg-black/40 rounded-lg md:rounded-xl shadow-inner border border-white/5 group-hover:border-white/20 transition-colors">
          ...
          <div className="relative z-10">
            <p className="text-[10px] md:text-xs font-bold text-zinc-500 uppercase tracking-wider mb-1 italic group-hover:text-zinc-400 transition-colors">
              {card.title}
            </p>
            <p className={`text-xl md:text-3xl font-black ${card.valueColor} tracking-tight drop-shadow-lg`}>
